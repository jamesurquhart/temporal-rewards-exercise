...
public class RewardsProgramWorker {
    ...
    public static void main(String[] args) {
        ...
        Worker worker = factory.newWorker(Shared.REWARDS_TASK_QUEUE);
        ...
        worker.registerActivitiesImplementations(new UpdateRewardsActivityImpl(), new CancelRewardsProgramActivityImpl());
